...
//                     <i className={`bi ${icon} display-4 text-warning mb-2`}></i>
//                     <h6 className="text-muted">{title}</h6>
//                     <h3 className="text-warning fw-bold">{value}</h3>
//                 </div>
//             </div>
//         </div>
//     );
...
//                 <div>
//                     <h2 className="page-title text-warning">Cashier Dashboard</h2>
...
//             {/* SECOND ROW - ROOM BILLING */}
//             <div className="row mt-3">
//                 <Card
//                     title="Room Billing Pending"
//                     value={stats.roomBillingPending || 0}
//                     icon="bi-receipt"
//                 />
//             </div>
...
//                     <div className="card card-premium">
//                         <div className="card-header bg-light">Quick Actions</div>
//                         <div className="p-3 d-flex flex-column gap-2">
//                             <button className="btn btn-warning" onClick={() => navigate("/billing")}>
//                                 <i className="bi bi-cash-coin"></i> Process Payment
//                             </button>
//                             <button className="btn btn-light" onClick={() => navigate("/booking")}>
//                                 <i className="bi bi-calendar-check"></i> Walk-in Booking
//                             </button>
//                             <button className="btn btn-light" onClick={() => navigate("/checkin")}>
//                                 <i className="bi bi-arrow-left-right"></i> Check-in/Out
//                             </button>
//                             <button className="btn btn-light" onClick={() => navigate("/room-billing")}>
//                                 <i className="bi bi-receipt"></i> Room Billing
//                             </button>
//                             <button className="btn btn-light" onClick={() => navigate("/combined-billing")}>
//                                 <i className="bi bi-file-earmark-pdf"></i> Combined Billing
//                             </button>
//                             <button className="btn btn-light" onClick={() => navigate("/id-verification")}>
//                                 <i className="bi bi-person-badge"></i> ID Verification
//                             </button>
//                         </div>
//                     </div>
...
//                         <div className="card-header bg-light">Daily Summary</div>
//                         <div className="p-3">
